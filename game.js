(function (window, document) {
  ...
  Game.prototype.drawWelcomePage = function () {
    ...
    this.ctx.fillText("Press enter to Start", 55, 110);
  };
  ...
  Game.prototype.start = function () {
    ...
    function render () {
      game.ctx.font = "6pt 'Press Start 2P'";
  ...
  Game.prototype.gameover = function () {
    ...
    this.ctx.fillText("GAME OVER", 120, 110);
    this.ctx.font = "8pt 'Press Start 2P'";
    this.ctx.fillText("Press enter to play again!", 100, 150);
    this.ctx.restore();
  ...
  Gap.prototype.pipeImage.src = "img/blocks.png";
  ...
  Bird.prototype.image.src = "img/starButterfly.png";
